# Generated by Django 3.1.6 on 2021-05-22 09:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing_pic', models.ImageField(blank=True, null=True, upload_to='photos/%Y/%m/%d')),
                ('category', models.CharField(max_length=64)),
                ('date_added', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='listings', to=settings.AUTH_USER_MODEL, verbose_name='users')),
        ...
        migrations.AddField(
            model_name='user',
            name='watchlist',
            field=models.ManyToManyField(related_name='watchlist', to='auctions.Listings', verbose_name='watchlists'),
        ),
    ]
